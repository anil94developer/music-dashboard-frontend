...
const base = {
  ...
  publicCompanyRegister: mainUrl + 'company/public-register', // Public company registration endpoint
  ...
  addMembership: mainUrl + 'admin/add-membership',
  membershipList: mainUrl + 'admin/membership-list',
  getMembershipById: mainUrl + 'admin/membership',
  updateMembership: mainUrl + 'admin/update-membership',
  deleteMembership: mainUrl + 'admin/delete-membership',
  changeMembershipStatus: mainUrl + 'admin/change-membership-status',
  activeMemberships: mainUrl + 'admin/active-memberships',
  updateUserPlan: mainUrl + 'admin/update-user-plan',
