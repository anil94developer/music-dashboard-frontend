        ...
        <div className="content-main">
          <section className="daily-trends-page">
            ...
            <div className="daily-trends-header">
              <h1>
                <i className="fa fa-store"></i> Top Store Report
              </h1>
              <p className="daily-trends-subtitle">Store earnings and analytics</p>
            </div>
          ...
          <div className="row">
            ...
            <div className="trend-card">
              <div className="card-header-section">
                <h2>
                  <i className="fa fa-store"></i> Top Store Earnings
                </h2>
                  <button
                  ...
                  <>
                    ...
                    <div className="table-container" style={{ marginTop: '30px' }}>
                      <h4 className="table-title">
                        <i className="fa fa-table"></i> Store Earnings Table
                      </h4>
